    ...
    <div>
        <div class="wrap">
            <el-breadcrumb separator="/">
                <el-breadcrumb-item :to="{ path: '/index/teamDetail/'+teamId }">工坊</el-breadcrumb-item>
                <el-breadcrumb-item>编辑工坊</el-breadcrumb-item>
            </el-breadcrumb>
        </div>
        <div class="content">
<!--            <p>工坊类别</p>-->
...
<!--                    <el-button type="primary" size="small" icon="el-icon-edit" @click="dialogTeacherVisible =true">添加老师</el-button>-->
                </div>
                <div class="view">
                    <el-tag
            ...
            <div>
                <div class="flex">
<!--                    <el-button type="primary" size="small">批量删除</el-button>-->
<!--                    <el-button type="primary" size="small" icon="el-icon-edit" @click="dialogStudentVisible = true">添加成员</el-button>-->
                </div>
                <div class="view">
                    <el-tag
                            style="margin-right: 15px"
...
<script>
    ...
    export default {
        ...
        mounted(){
          ...
          // })
            this.axios.post('/teamproject/manage/editaddworkshop',{
                userId:this.$store.state.user.userId,
