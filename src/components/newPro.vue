    ...
    <div>
        <div class="wrap">
            <el-breadcrumb separator="/">
                <el-breadcrumb-item :to="{ path: '/index/Ttem_Pandect' }">项目</el-breadcrumb-item>
                <el-breadcrumb-item>创建创业项目</el-breadcrumb-item>
            </el-breadcrumb>
        </div>
        <div class="content">
<!--            <p>工坊类别</p>-->
...
<!--            </el-radio-group>-->
            <p>项目名称</p>
            <el-input placeholder="请输入内容" class="wid" v-model="name"></el-input>
            <p>项目创建时间</p>
            <div class="wid">
                <el-date-picker
                        style="width: 350px"
            ...
            <el-input
                    ...
                    type="textarea"
                    :rows="4"
                    placeholder="200字以内，介绍项目业务/定位，请勿有公司名称"
                    v-model="textarea">
            </el-input>
...
<!--            </div>-->
            <div style="padding: 25px 20px">
                ...
                <el-button plain @click="giveup">放弃审批</el-button>
        ...
        <el-dialog v-if="false" title="招聘职位编辑" :visible.sync="dialogDutyVisible">
...
<script>
    ...
    export default {
        ...
        mounted(){
            ...
            //     // this.$set(this.teamData,'data',res.data.data.teamBean);
        ...
        methods:{
            ...
            commit(){
                this.axios.post('/teamproject/common/uploadimg',{
