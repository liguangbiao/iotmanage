  ...
  <div>
    <div class="wrap">
      <el-breadcrumb separator="/">
        <el-breadcrumb-item :to="{ path: '/index/innovativeTeam' }">项目</el-breadcrumb-item>
    ...
    <div id="mc-content">
      <div class="mc-content-head clear">
        <div class="floatLeft">
          <img :src="teamInfo.imgAddress||'/asset//docsave/manage/team/21/image/一佳一项目.jpg'">
...
<!--          <a @click.stop="start1" class="if_admin">-->
      ...
      <div style="margin-top: 50px">
        <el-tabs v-model="activeName" @tab-click="handleClick" v-show="activeIndex==1">
              ...
              <ul class="team_leaguer">
                ...
                >
                  ...
                  <div class="overflow">
                    ...
                    <p>
                      <span class="root_power admin_people">项目成员</span>
                    </p>
                  </div>
                </li>
              </ul>
          ...
          <!-- <el-tab-pane label="项目项目" name="2">项目项目</el-tab-pane> -->
          <el-tab-pane label="项目事记" name="2">
            <div>
    ...
    <el-dialog title="等级设置" :visible.sync="dialogVisible">
      <div class="con">
        <p>项目等级</p>
        <div>
          <el-radio-group v-model="DevRadio">
            <el-radio
              :label="DevItem.id"
    ...
    <el-dialog title="增加项目成员" :visible.sync="dialogStudentVisible">
